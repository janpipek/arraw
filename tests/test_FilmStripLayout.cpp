...
TEST_CASE("cellWidth fits the thumbnail to the strip height by aspect ratio", "[filmstrip]") {
...
TEST_CASE("cellWidth falls back to a square cell for degenerate sizes", "[filmstrip]") {
