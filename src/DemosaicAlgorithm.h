...
// Per-image demosaic algorithm selection (issue #22, docs/adr/0033).
//
...
// an X-Trans Markesteijn menu are deferred (see ADR 0033).
...
// libraw `imgdata.params.user_qual` integer for an algorithm (ADR 0033 table).
...
// offering Bayer labels that would not run (ADR 0033).
