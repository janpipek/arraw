...
Gains whiteBalanceDelta(const CameraNative& camera, const ColorSettings& settings) {
...
Matrix3 arraw::colorMatrixFor(const ColorEncoding& encoding, const ColorSettings& settings) {
