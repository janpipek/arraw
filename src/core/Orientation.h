...
// Rotation (CONTEXT.md, docs/adr/0029). Pure value type + EXIF mapping, so it
...
// in lock-step with the shader (docs/adr/0029).
...
// plain increment of quarterTurnsCW (docs/adr/0029).
